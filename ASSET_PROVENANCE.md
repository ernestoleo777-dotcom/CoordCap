...
- Python implementation, canonical scripts, and lightweight tests: `AUTHOR_OWNED_RIGHTS_CONFIRMED` for this owner-authorized local projection; public licensing remains pending.
